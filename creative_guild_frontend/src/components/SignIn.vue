<template>
  <div class="wrapper-signin">
    ...
    <h1 class="primary-font">Login to your account</h1>
    <h2 class="secondary-font">
      Don't have an account?
      <router-link class="cg-link" to="/signup">Create an Account</router-link>
    </h2>
    <div v-if="message" class="error-message">{{ message }}</div>

    <div class="form-container">
      <form @submit.prevent="handleSubmit" class="login-form" id="signInForm">
        <div class="form-field-wrapper">
          ...
          <div class="forgot-password">
            <router-link to="/reset_password" class="cg-link secondary-font"
